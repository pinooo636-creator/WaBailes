export const getAdditionalNode = export const getBinaryNodeFilter = export const binaryNodeToString = export const getBinaryNodeMessages = export const reduceBinaryNodeToDictionary = export const assertNodeErrorFree = export const getBinaryNodeChildUInt = export const getBinaryNodeChildString = export const getBinaryNodeChildBuffer = export const getBinaryNodeChild = export const getAllBinaryNodeChildren = export const getBinaryNodeChildren = void 0;
...
export const getBinaryNodeChildren = getBinaryNodeChildren;
...
export const getAllBinaryNodeChildren = getAllBinaryNodeChildren;
const getBinaryNodeChild = (node, childTag) => {
    if (Array.isArray(node?.content)) {
        return node?.content.find(item => item.tag === childTag)
    }
}
export const getBinaryNodeChild = getBinaryNodeChild;
...
export const getBinaryNodeChildBuffer = getBinaryNodeChildBuffer;
...
export const getBinaryNodeChildString = getBinaryNodeChildString;
...
export const getBinaryNodeChildUInt = getBinaryNodeChildUInt;
...
export const assertNodeErrorFree = assertNodeErrorFree;
...
export const reduceBinaryNodeToDictionary = reduceBinaryNodeToDictionary;
...
export const getBinaryNodeMessages = getBinaryNodeMessages;
...
export const binaryNodeToString = binaryNodeToString;
...
export const getBinaryNodeFilter = getBinaryNodeFilter;
...
export const getAdditionalNode = getAdditionalNode;
