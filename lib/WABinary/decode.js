...
export const decodeBinaryNode = export const decodeDecompressedBinaryNode = export const decompressingIfRequired = void 0;
import zlib_1 from "zlib";
const constants = __importStar(require("./constants"));
import jid_utils_1 from "./jid-utils";
...
export const decompressingIfRequired = decompressingIfRequired;
...
export const decodeDecompressedBinaryNode = decodeDecompressedBinaryNode;
...
export const decodeBinaryNode = decodeBinaryNode;
