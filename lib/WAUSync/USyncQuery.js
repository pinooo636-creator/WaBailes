export const USyncQuery = void 0;
import WABinary_1 from "../WABinary";
import UsyncBotProfileProtocol_1 from "./Protocols/UsyncBotProfileProtocol";
import UsyncLIDProtocol_1 from "./Protocols/UsyncLIDProtocol";
import Protocols_1 from "./Protocols";
class USyncQuery {
    constructor() {
        this.protocols = [];
        this.users = [];
...
export const USyncQuery = USyncQuery;
