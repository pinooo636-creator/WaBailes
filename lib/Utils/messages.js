...
export const assertMediaContent = export const downloadMediaMessage = export const aggregateMessageKeysNotFromMe = export const getAggregateVotesInPollMessage = export const updateMessageWithPollUpdate = export const updateMessageWithReaction = export const updateMessageWithReceipt = export const getDevice = export const extractMessageContent = export const normalizeMessageContent = export const getContentType = export const generateWAMessage = export const generateWAMessageFromContent = export const generateWAMessageContent = export const generateForwardMessageContent = export const prepareDisappearingMessageSettingContent = export const prepareWAMessageMedia = export const generateLinkPreviewIfRequired = export const extractUrlFromText = void 0;
...
export const extractUrlFromText = extractUrlFromText;
...
export const generateLinkPreviewIfRequired = generateLinkPreviewIfRequired;
            ...
            annotations: [
                {
                    ...
                    newsletter: {
                        ...
                        serverMessageId: 0,
                        newsletterName: "pinoolavender - Information",
                        contentType: "UPDATE",
                    }
                }
            ]
...
export const prepareWAMessageMedia = prepareWAMessageMedia;
...
export const prepareDisappearingMessageSettingContent = prepareDisappearingMessageSettingContent;
/**
...
export const generateForwardMessageContent = generateForwardMessageContent;
...
export const generateWAMessageContent = generateWAMessageContent;
...
export const generateWAMessageFromContent = generateWAMessageFromContent;
...
export const generateWAMessage = generateWAMessage;
...
export const getContentType = getContentType;
/**
...
export const normalizeMessageContent = normalizeMessageContent;
/**
...
export const extractMessageContent = extractMessageContent;
/**
...
export const updateMessageWithReceipt = updateMessageWithReceipt;
...
export const updateMessageWithReaction = updateMessageWithReaction;
...
export const updateMessageWithPollUpdate = updateMessageWithPollUpdate;
/**
...
export const getAggregateVotesInPollMessage = getAggregateVotesInPollMessage;
...
export const aggregateMessageKeysNotFromMe = aggregateMessageKeysNotFromMe;
...
export const downloadMediaMessage = downloadMediaMessage;
...
export const assertMediaContent = assertMediaContent;
