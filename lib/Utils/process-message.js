export const decryptPollVote = export const getChatId = export const shouldIncrementChatUnread = export const isRealMessage = export const cleanMessage = void 0;
import WAProto_1 from "../../WAProto";
import Types_1 from "../Types";
import messages_1 from "../Utils/messages";
import WABinary_1 from "../WABinary";
import crypto_1 from "./crypto";
import generics_1 from "./generics";
import history_1 from "./history";
...
export const isRealMessage = isRealMessage;
const shouldIncrementChatUnread = (message) => (!message.key.fromMe && !message.messageStubType);
export const shouldIncrementChatUnread = shouldIncrementChatUnread;
/**
...
export const decryptPollVote = decryptPollVote;
...
export const default = processMessage;
