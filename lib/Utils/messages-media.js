...
export const getStatusCodeForMediaRetry = export const decryptMediaRetryData = export const decodeMediaRetryNode = export const encryptMediaRetryRequest = export const getWAUploadToServer = export const extensionForMediaMessage = export const downloadEncryptedContent = export const downloadContentFromMessage = export const getUrlFromDirectPath = export const encryptedStream = export const prepareStream = export const getHttpStream = export const generateThumbnail = export const getStream = export const toBuffer = export const toReadable = export const getAudioWaveform = export const getAudioDuration = export const mediaMessageSHA256B64 = export const generateProfilePicture = export const encodeBase64EncodedStringForUpload = export const extractImageThumb = export const getMediaKeys = export const hkdfInfoKey = void 0;
...
export const hkdfInfoKey = hkdfInfoKey;
...
export const getMediaKeys = getMediaKeys;
...
export const extractImageThumb = extractImageThumb;
const encodeBase64EncodedStringForUpload = (b64) => (encodeURIComponent(b64
    .replace(/\+/g, '-')
    .replace(/\//g, '_')
    .replace(/\=+$/, '')));
export const encodeBase64EncodedStringForUpload = encodeBase64EncodedStringForUpload;
...
export const generateProfilePicture = generateProfilePicture;
/** gets the SHA256 of the given media message */
const mediaMessageSHA256B64 = (message) => {
    const media = Object.values(message)[0];
    return (media === null || media === void 0 ? void 0 : media.fileSha256) && Buffer.from(media.fileSha256).toString('base64');
};
export const mediaMessageSHA256B64 = mediaMessageSHA256B64;
...
export const getAudioDuration = getAudioDuration;
...
export const getAudioWaveform = getAudioWaveform;
...
export const convertToOpusBuffer = convertToOpusBuffer;
...
export const toReadable = toReadable;
...
export const getStream = getStream;
...
export const generateThumbnail = generateThumbnail;
const getHttpStream = async (url, options = {}) => {
    const { default: axios } = await import('axios');
    const fetched = await axios.get(url.toString(), { ...options, responseType: 'stream' });
    return fetched.data;
};
export const getHttpStream = getHttpStream;
...
export const prepareStream = prepareStream;
...
export const encryptedStream = encryptedStream;
...
export const getUrlFromDirectPath = getUrlFromDirectPath;
const downloadContentFromMessage = ({ mediaKey, directPath, url }, type, opts = {}) => {
    const downloadUrl = url || (0, exports.getUrlFromDirectPath)(directPath);
    const keys = getMediaKeys(mediaKey, type);
    return (0, exports.downloadEncryptedContent)(downloadUrl, keys, opts);
};
export const downloadContentFromMessage = downloadContentFromMessage;
/**
...
export const downloadEncryptedContent = downloadEncryptedContent;
...
export const extensionForMediaMessage = extensionForMediaMessage;
...
export const getWAUploadToServer = getWAUploadToServer;
...
export const encryptMediaRetryRequest = encryptMediaRetryRequest;
...
export const decodeMediaRetryNode = decodeMediaRetryNode;
const decryptMediaRetryData = ({ ciphertext, iv }, mediaKey, msgId) => {
    const retryKey = getMediaRetryKey(mediaKey);
    const plaintext = (0, crypto_1.aesDecryptGCM)(ciphertext, retryKey, iv, Buffer.from(msgId));
    return WAProto_1.proto.MediaRetryNotification.decode(plaintext);
};
export const decryptMediaRetryData = decryptMediaRetryData;
const getStatusCodeForMediaRetry = (code) => MEDIA_RETRY_STATUS_MAP[code];
export const getStatusCodeForMediaRetry = getStatusCodeForMediaRetry;
