...
export const makeChatsSocket = void 0;
...
import make_mutex_1 from "../Utils/make-mutex";
import process_message_1 from "../Utils/process-message";
import WABinary_1 from "../WABinary";
import socket_1 from "./socket";
import WAUSync_1 from "../WAUSync";
import usync_1 from "./usync";
...
const makeChatsSocket = (config) => {
    ...
    const checkStatusWA = async (phoneNumber) => {
        ...
        try {
            import { useMultiFileAuthState, Browsers, fetchLatestBaileysVersion } from "../Utils";
...
export const makeChatsSocket = makeChatsSocket;
